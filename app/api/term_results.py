...
from app.schemas.term_result import (
    AttendanceSummary,
    ReportCommentSummary,
    StudentTermResultResponse,
)
...
@router.get(
    "/student/{student_id}",
    response_model=StudentTermResultResponse,
)
def get_student_term_result(
    ...
    # ---------------------------------------------------------
    # 9. GET SCORES FOR ALL CLASS STUDENTS
    # ---------------------------------------------------------
    ...
    if comment_record is not None:
        comments_summary = ReportCommentSummary(
            teacher_comment=(
    ...
    # ---------------------------------------------------------
    # 15. RETURN TERM RESULT
    # ---------------------------------------------------------

    return StudentTermResultResponse(
